      ...
      <div class="flex justify-between items-center h-18">
        ...
        <div class="hidden sm:flex sm:items-center sm:space-x-8">
          <RouterLink
            ...
            active-class="text-pres-red font-semibold"
            >Home</RouterLink
          >
          <RouterLink
            to="/directory"
        ...
        <div class="flex items-center sm:hidden">
          <button
            @click="toggleMenu"
            type="button"
            class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-pres-red"
    ...
    >
      <div class="pt-2 pb-3 space-y-1">
        <RouterLink
          @click="toggleMenu"
          to="/"
          class="block px-4 py-2 text-base font-medium text-gray-700 hover:text-pres-red hover:bg-gray-50"
